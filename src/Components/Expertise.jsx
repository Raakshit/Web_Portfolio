...
const ExpertiseCard = ({ title, description, icon: Icon }) => (
  <div className="bg-white rounded-lg shadow-md p-6 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
    <div className="flex items-center justify-center w-12 h-12 bg-amber-400 rounded-full mb-4">
...
const Expertise = () => {
  ...
  return (
    <section className="bg-[#EAEAEA] py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
